  ...
  >
    ...
    >
      ...
      <el-tab-pane
        ...
        :name="item.name"
      >
        <el-card style="border-radius: 0px" :body-style="siteContentViewHeight">
          <iframe
    ...
    siteContentViewHeight() {
      ...
      if (this.$route.meta.isTab) {
        ...
        return isURL(this.$route.meta.iframeUrl)
          ? { height: height + "px" ,padding:'0!important'}
          : { minHeight: height + "px",padding:'0 !important' };
      }
      return { minHeight: height + "px" ,padding: '0 !important'};
    },
  },
  methods: {
    // tabs, 选中tab
