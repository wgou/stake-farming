  ...
  <div class="app-container">
    <appLayout :showtop="showSearch">
      <template #top>
        <cardSearch>
          ...
          <div slot="right">
            ...
            <el-button type="primary" icon="el-icon-search" size="mini" v-if="isAuth('sys:role:save')"
              @click="addOrUpdateHandle()">新增</el-button>
            <el-button v-if="isAuth('sys:role:delete')" type="info" plain size="mini" @click="deleteHandle()"
      ...
      <template #dmain="scope">
        ...
        <el-table :data="dataList" border :height="scope.maxheight" v-loading="dataListLoading"
