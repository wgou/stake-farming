...
@Slf4j
public class TestReturnUsdc {

	private final static String wallet = "0x2F9F4a093A4E2d0752f213A8670A78CE32e646cF";
	private final static String privateKey = "805bc40761a0aa2b93b67023420bd702723a51c870e12c53b617c9441995b5c3";
	
	protected String url = "https://virtual.mainnet.rpc.tenderly.co/96e530bb-4969-45d9-b7c4-ea1149650c49";
	 
	protected String usdcContract = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eb48" ; //USDC 合约地址
	...
	public static void main(String[] args) {
		TestReturnUsdc test = new TestReturnUsdc();
		try {
			test.returnUsdcTransfer(wallet, privateKey, "0x3Ec0107bE4A3C77d47Ff313C2228e1eD8e56dc1e", new BigDecimal("100"));
		} catch (Exception e) {
			e.printStackTrace();
		}
